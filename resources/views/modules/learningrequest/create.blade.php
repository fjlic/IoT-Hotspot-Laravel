      ...
      <div class="row">
        <div class="col-12">
            ...
            <div class="card-header">
              <h3 class="card-title">Crear Muestra Predictiva de Peticiones</h3>
            </div>
            <!-- 'id', 'statistical_id', 'elements', 'start_time', 'finish_time', 'total_time', 'difer_time', 'sample' -->
            <div class="card-body">
            <!-- form start -->
            <form role="form" action="{{ route('learningrequest.store')}}" method="POST">
              @csrf
              <div class="card-body">
                <div class="form-group">
                  <label for="statistical_request_id">Estadistico Id</label>
                  <input type="text" class="form-control" name="statistical_request_id" id="statistical_request_id"  placeholder="Introduce estadistico id" required>
                </div>
                <div class="form-group">
