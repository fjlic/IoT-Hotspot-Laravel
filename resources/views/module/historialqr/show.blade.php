      ...
      <div class="row">
        <div class="col-xs-12">
            ...
            <div class="box-header">
              <h3 class="box-title">Ver HIstorial Qr</h3>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
                  <!-- form start -->
            ...
            <form role="form">
              <div class="box-body">
                ...
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" value="{{ $historialqr->key_status }}" readonly="readonly"/>
                </div>
                <div class="form-group">
                  <label for="gone_down">Actualizado</label>
                  <input type="text" class="form-control" value="{{ $historialqr->gone_down }}" readonly="readonly"/>
                </div>
              </div>
              <!-- /.box-body -->
