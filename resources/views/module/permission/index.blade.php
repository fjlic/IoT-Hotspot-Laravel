...
@section('title', 'Hotspot|Permisos')
              ...
              <table id="permissionTable" class="table table-bordered table-striped">
                ...
                <tr>
                    ...
                    <td>
                      ...
                      @csrf
                      @method('DELETE')
                      <a href="" class="btn btn-danger btn-xs" data-toggle="modal" data-target="#exampleModalCenter{{$permission->id}}"><span class="fas fa-trash"></span></a>
                      ...
                      <div class="modal-body">
                          <div class="modal-body" style="text-align: center">
                           ...
                           <br>
                          <p class="text-center">Eliminarás ( <b>{{$permission->display_name}}</b> ) seguro?</p>
                      </div>
