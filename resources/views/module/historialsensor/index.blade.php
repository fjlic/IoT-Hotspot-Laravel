...
@section('title', 'Hotspot|Historial|Sensors')
      ...
      <div class="row">
        <div class="col-12">
            ...
            <div class="card-header">
              <h3 class="card-title">Sensor History Table</h3>
                    ...
                    <td>
                      ...
                      <div class="modal-body">
                          <div class="modal-body" style="text-align: center">
                           ...
                           <br>
                          <p class="text-center">Do you will delete ( <b>{{$historialsensor->num_serie}}</b> ) are you sure ?</p>
                      </div>
