      ...
      <div class="row">
        <div class="col-12">
            ...
            <div class="card-header">
              <h3 class="card-title">Sensor History Create</h3>
            </div>
            <!-- /.card-header -->
            <div class="card-body">
                  <!-- form start -->
            <form role="form" action="{{ route('historialsensor.store')}}" method="POST">
              ...
              <div class="card-body">
                <div class="form-group">
                  <label for="num_serie">Serie Number</label>
                ...
                -->
                <div class="form-group">
                    <label for="sensor_id">Assign Sensor</label>
              ...
              <div class="card-footer">
                <a href="{{ route('historialsensor.index') }}" class="btn btn-default">Cancel</a>
