                ...
                <tr>
                   ...
                   {{--   <td>{{ $historialerb->password }}</td> --}}
                    ...
                    <td>
                      ...
                      @csrf
                      @method('DELETE')
                      <a href="" class="btn btn-danger btn-xs" data-toggle="modal" data-target="#exampleModalCenter{{$historialerb->id}}"><span class="fas fa-trash"></span></a>
                      <!------ ESTE ES EL MODAL QUE SE MUESTRA AL DAR CLICK EN EL BOTON "ELIMINAR" ------>
                      <div class="modal fade" id="exampleModalCenter{{$historialerb->id}}" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
                      ...
                      <div class="modal-body">
                          <div class="modal-body" style="text-align: center">
                           ...
                           <br>
                          <p class="text-center">Eliminarás ( <b>{{$historialerb->nick_name}}</b> ) seguro?</p>
                      </div>
